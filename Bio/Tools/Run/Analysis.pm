...
=head1 SYNOPSIS
  ...
  #
  # --- Using generator 'applmaker.pl':
  #

  # this will generate module Seqret.pm
  applmaker.pl -n edit::seqret -m Seqret
...
public methods) is in the script C<analysis.pl> (go to the C<scripts>
directory and type C<perldoc analysis.pl>).
...
C<applmaker.pl> generator. Its features and usage are documented in
