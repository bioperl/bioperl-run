# $Id$
# BioPerl module for Bio::Tools::Run::PiseApplication::shuffleseq
#
...
Bio::Tools::Run::PiseApplication::shuffleseq
	...
	SHUFFLESEQ	Shuffles a set of sequences maintaining composition (EMBOSS)
      ...
      Parameters: 
        ...
        (see also:
          http://bioweb.pasteur.fr/seqanal/interfaces/shuffleseq.html 
...
=head2 new
 ...
 Title   : new()
 Usage   : my $shuffleseq = Bio::Tools::Run::PiseApplication::shuffleseq->new($location, $email, @params);
