# $Id$
# BioPerl module for Bio::Tools::Run::PiseApplication::preg
#
...
Bio::Tools::Run::PiseApplication::preg
	...
	PREG	Regular expression search of a protein sequence (EMBOSS)
      ...
      Parameters: 
        ...
        (see also:
          http://bioweb.pasteur.fr/seqanal/interfaces/preg.html 
...
=head2 new
 ...
 Title   : new()
 Usage   : my $preg = Bio::Tools::Run::PiseApplication::preg->new($location, $email, @params);
