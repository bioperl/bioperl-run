# $Id$
# BioPerl module for Bio::Tools::Run::PiseApplication::biosed
#
...
Bio::Tools::Run::PiseApplication::biosed
	...
	BIOSED	Replace or delete sequence sections (EMBOSS)
      ...
      Parameters: 
        ...
        (see also:
          http://bioweb.pasteur.fr/seqanal/interfaces/biosed.html 
...
=head2 new
 ...
 Title   : new()
 Usage   : my $biosed = Bio::Tools::Run::PiseApplication::biosed->new($location, $email, @params);
