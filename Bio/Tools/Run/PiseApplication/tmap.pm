# $Id$
# BioPerl module for Bio::Tools::Run::PiseApplication::tmap
#
...
Bio::Tools::Run::PiseApplication::tmap
	...
	TMAP	Displays membrane spanning regions (EMBOSS)
      ...
      Parameters: 
        ...
        (see also:
          http://bioweb.pasteur.fr/seqanal/interfaces/tmap.html 
...
=head2 new
 ...
 Title   : new()
 Usage   : my $tmap = Bio::Tools::Run::PiseApplication::tmap->new($location, $email, @params);
