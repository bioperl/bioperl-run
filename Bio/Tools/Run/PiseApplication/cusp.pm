# $Id$
# BioPerl module for Bio::Tools::Run::PiseApplication::cusp
#
...
Bio::Tools::Run::PiseApplication::cusp
	...
	CUSP	Create a codon usage table (EMBOSS)
...
#'
package Bio::Tools::Run::PiseApplication::cusp;
...
=head2 new
 ...
 Title   : new()
 Usage   : my $cusp = Bio::Tools::Run::PiseApplication::cusp->new($location, $email, @params);
 Function: Creates a Bio::Tools::Run::PiseApplication::cusp object.
           This method should not be used directly, but rather by 
           a Bio::Tools::Run::AnalysisFactory::Pise instance.
           my $factory = Bio::Tools::Run::AnalysisFactory::Pise->new();
           my $cusp = $factory->program('cusp');
 Example : -
 Returns : An instance of Bio::Tools::Run::PiseApplication::cusp.
...
# -- begin of definitions extracted from /local/gensoft/lib/Pise/5.a/PerlDef/cusp.pm

    $self->{COMMAND}   = "cusp";
    $self->{VERSION}   = "5.a";
    $self->{TITLE}   = "CUSP";

    $self->{DESCRIPTION}   = "Create a codon usage table (EMBOSS)";
    ...
    $self->{DOCLINK}   = "http://www.uk.embnet.org/Software/EMBOSS/Apps/cusp.html";
...
# -- end of definitions extracted from /local/gensoft/lib/Pise/5.a/PerlDef/cusp.pm
