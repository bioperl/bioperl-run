...
Bio::Tools::Run::PiseApplication::backtranseq
	...
	BACKTRANSEQ	Back translate a protein sequence (EMBOSS)
      ...
      Parameters:
		...
		sequence (Sequence)
			sequence -- PureProtein [single sequence] (-sequence)
			pipe: seqfile
...
=head2 new
 ...
 Title   : new()
 Usage   : my $backtranseq = Bio::Tools::Run::PiseApplication::backtranseq->new($remote, $email, @params);
...
# -- begin of definitions extracted from /local/gensoft/lib/Pise/5.a/PerlDef/backtranseq.pm
	...
	"init",
	"input", 	# input Section
	"sequence", 	# sequence -- PureProtein [single sequence] (-sequence)
