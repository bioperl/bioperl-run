# $Id$
# BioPerl module for Bio::Tools::Run::PiseApplication::dreg
#
...
Bio::Tools::Run::PiseApplication::dreg
	...
	DREG	regular expression search of a nucleotide sequence (EMBOSS)
      ...
      Parameters: 
        ...
        (see also:
          http://bioweb.pasteur.fr/seqanal/interfaces/dreg.html 
...
=head2 new
 ...
 Title   : new()
 Usage   : my $dreg = Bio::Tools::Run::PiseApplication::dreg->new($location, $email, @params);
