# $Id$
# BioPerl module for Bio::Tools::Run::PiseApplication::water
#
...
#'
package Bio::Tools::Run::PiseApplication::water;
...
=head2 new
 ...
 Title   : new()
 Usage   : my $water = Bio::Tools::Run::PiseApplication::water->new($location, $email, @params);
 Function: Creates a Bio::Tools::Run::PiseApplication::water object.
           This method should not be used directly, but rather by 
           a Bio::Tools::Run::AnalysisFactory::Pise instance.
           my $factory = Bio::Tools::Run::AnalysisFactory::Pise->new();
           my $water = $factory->program('water');
 Example : -
 Returns : An instance of Bio::Tools::Run::PiseApplication::water.
...
# -- begin of definitions extracted from /local/gensoft/lib/Pise/5.a/PerlDef/water.pm

    $self->{COMMAND}   = "water";
    $self->{VERSION}   = "5.a";
    $self->{TITLE}   = "WATER";

    $self->{DESCRIPTION}   = "Smith-Waterman local alignment. (EMBOSS)";
    ...
    $self->{DOCLINK}   = "http://www.uk.embnet.org/Software/EMBOSS/Apps/water.html";
...
# -- end of definitions extracted from /local/gensoft/lib/Pise/5.a/PerlDef/water.pm
